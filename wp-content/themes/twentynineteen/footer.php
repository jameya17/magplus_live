...
<script type="text/javascript">
    jQuery(document).ready(function() {
        jQuery(".icon-burger").click(function() {
            if (jQuery(this).hasClass("is-open")) {
                ...
                jQuery(".sticky-nav-tabs").removeClass("open-slide");
                return false;
            } else {
                jQuery(this).addClass("is-open");
                jQuery(".sticky-nav-tabs").addClass("open-slide");
                return false;
            }
        });
        ...
        jQuery('.acc-item').click(function() {
            if (jQuery(this).hasClass("open")) {
                ...
                jQuery(".acc-item").children(".acc-ans").slideUp();
            } else {
                jQuery(".acc-item").removeClass("open");
                jQuery(this).addClass("open");
                jQuery(".acc-item").children(".acc-ans").slideUp();
                jQuery(this).children(".acc-ans").slideDown();
            }
            return false;
        });
        ...
        jQuery(".two-col-carousel").owlCarousel({
            items: 1,
            loop: false,
            margin: 10,
            nav: false,
        ...
        jQuery(".five-col-carousel").owlCarousel({
            items: 1,
            loop: false,
            margin: 10,
            nav: true,
        ...
        jQuery('.toggle').click(function(e) {
            ...
            if (jQuerythis.next().hasClass('show')) {
                ...
                jQuerythis.parent().parent().find('.inner').removeClass('show');
                jQuerythis.parent().parent().find('.inner').slideUp(350);
        ...
        if(jQuery(window).width() > 1024){
            ...
            var blockHeight = jQuery(window).height() - 68 ;

            jQuery("#banner").css('height', blockHeight);
        ...
        if (jQuery(window).width() < 1024) {
            ...
            jQuery('.sidebar-listing .checkbox-container').click(function() {
        ...
        jQuery(".mob-select .options ul li a").click(function() {
            var text = jQuery(this).html();
            var target = jQuery(jQuery(this).attr("href"));
            jQuery(".mob-select .selected a span").html(text);
        ...
        jQuery(".mob-select .options ul li a").click(function() {
            ...
            if (select == 'publish') {
                ...
                jQuery('.plan-td').hide();
                jQuery('.plan-td.multi-pro').show();
            }
            else if (select == 'unlimited'){
                jQuery('.plan-td').hide();
                jQuery('.plan-td.unlimited').show();
            }
            else{
                alert();
                jQuery('.plan-td').hide();
    ...
    jQuery(window).scroll(function() {
        ...
        if (windscroll >= 69) {
            ...
            jQuery('.sticky-sidebar a.active').removeClass('active');
    ...
    TxtType.prototype.tick = function() {
        ...
        this.el.innerHTML = '<span class="type-text">'+this.txt+'</span>';
    ...
    window.onload = function() {
        ...
        // css.type = "text/css";
        // css.innerHTML = ".typewrite > .type-text: { border-right: 0.08em solid #fff}";
