            ...
            <div class="g-col align-center">
                <div class="content-block">
                    ...
                    <div class="small-wrap">
                        <p>Watch this carefully curated list of tutorial videos to help you kickstart your tour with using mag+. You can always reach out to us at <a href="mailto:support@magplus.com" target="_blank" title="support@magplus.com" class="text-link">support@magplus.com</a> if you need additional information on any of the topics.</p>
                    ...
                    <ul class="sidebar-listing">
                        ...
                        <li>
                            <label class="checkbox-container">Tutorials&nbsp;<span class="count">(<?php echo $countArray[1]; ?>)</span>
                                <input type="checkbox" class="checkboxTutorials" data-value="251">
                                <span class="checkmark"></span>
                            </label>
                        </li>
                        <li>
                            <label class="checkbox-container">Webinars&nbsp;<span class="count">(<?php echo $countArray[2]; ?>)</span>
                                <input type="checkbox" class="checkboxTutorials" data-value="268">
                                <span class="checkmark"></span>
                            </label>
                        </li>
                        <li>
