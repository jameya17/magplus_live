...
?>
     <div class="container">
        ...
        <section class="l-section sec-pad white-bg pad-top0">
            <div class="l-section-wrap">
                <div class="l-sub-section-pad">
                    <h3 class="mob-view">Creative Services</h3>
                    <div class="g-col">
                        <div class="one-half">
                            <h3 class="desk-view">Creative Services</h3>
        ...
        <section class="l-section sec-pad grey-bg">
            <div class="l-section-wrap">
                <div class="l-sub-section-pad">
                    <h3 class="mob-view">App Submission</h3>
                    <div class="g-col row-reverse">
                        <div class="one-half" data-aos="fade-left">
                            <h3 class="desk-view">App Submission</h3>
        ...
        <section class="l-section sec-pad white-bg">
            <div class="l-section-wrap">
                <div class="l-sub-section-pad">
                    <h3 class="mob-view">App Updation</h3>
                    <div class="g-col">
                        <div class="one-half" data-aos="fade-right">
                            <h3 class="desk-view">App Updation</h3>
