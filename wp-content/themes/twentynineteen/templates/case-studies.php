                    ...
                    <div class="l-sub-section-pad">
                        <div class="tab-section">
                            <ul class="tab-head">
                                ...
                                <li class="tab-item"><a href="#" class="tab-link casestudyLink" title="Advertisements" data-value="253">Advertisements</a></li>
                                <li class="tab-item"><a href="#" class="tab-link casestudyLink" title="Applications" data-value="255">Applications</a></li>
                            </ul>
                        </div>
